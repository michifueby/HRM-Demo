...
flowchart TB
    ...
    subgraph Frontend["Static Frontends (Angular)"]
        ...
        App1[HR-Core App<br/>Angular SPA]
        App2[HR-Metrics App<br/>Angular SPA]
        App3[HR-Activities App<br/>Angular SPA]
    end

    %% Backend APIs
    subgraph Backend["Backend APIs (Node.js + Express)"]
        direction TB
        EB_Core[Elastic Beanstalk\nhr-core-backend-env]
        EB_Met[Elastic Beanstalk\nhr-metrics-backend-env]
        EB_Act[Elastic Beanstalk\nhr-activities-backend-env]
    ...
    %% Connections
    User -->|https://hrm-core...| CF_Core
    User -->|https://hrm-metrics...| CF_Met
    User -->|https://hrm-activities...| CF_Act
    ...
    App1 -.->|fetch time| API_Core
    App2 -.->|fetch time| API_Met
    App3 -.->|fetch time| API_Act
    ...
    class App1,App2,App3,S3_Core,S3_Met,S3_Act frontend
    class EB_Core,EB_Met,EB_Act,API_Core,API_Met,API_Act backend
...
### Live URLs Frontend
- Core: http://d2son79tla3vi1.cloudfront.net    
- Metrics: http://d105yacdbjxloh.cloudfront.net 
- Activities: http://d30s3dsuv4afnh.cloudfront.net

### Live URLs Backend
- Core: http://hrm-core-backend-env.eba-mpjkpkpv.eu-central-1.elasticbeanstalk.com    
- Metrics: http://hrm-metrics-backend-env.eba-mpjkpkpv.eu-central-1.elasticbeanstalk.com 
- Activities: http://hrm-activities-backend-env.eba-mpjkpkpv.eu-central-1.elasticbeanstalk.com
...
1. Create an IAM OIDC Identity Provider for GitHub
    This removes the need for AWS keys in GitHub Secrets
...
2.  Create one IAM Role that GitHub Actions will assume
    ...
    (replace with real username/repo)
...
<br>
3. Create 3 S3 Buckets for the frontends
